...
export class ProductsController {
  ...
  async addVendors(
    ...
    return this.productsService.addVendors(id, body.vendorIds);
  }
  ...
  async removeVendors(
    ...
    return this.productsService.removeVendors(id, body.vendorIds);
  }

  @Get(':id/vendors')
  @ApiOperation({ summary: 'Get vendors for product' })
  @ApiResponse({ status: 200, description: 'Vendors retrieved successfully' })
  async getVendors(@Param('id') id: string) {
    return this.productsService.getVendors(id);
  }
}